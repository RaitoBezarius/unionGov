...
const SHARE_MESSAGE = 'La #démocratie ce n\'est pas seulement un.e président.e : venez vous inscrire avant le 23 janvier pour voter sur #PrimairePopulaire #PlusBelleLaPolitique #2022AvecVous';
