...
const Government: FunctionComponent<Props> = memo(({ items = EMPTY_ITEMS, thumbnailURL, permanentURL }) => (
  <div className="container mt-4 p-0 justify-content-center">
    ...
    <Typography variant="body1" className="flex-fill text-center pb-4" color="textSecondary">
      ...
      Proposez votre gouvernement idéal dans le cadre du Socle Commun https://primairepopulaire.fr/le-socle-commun/ porté par la Primaire Populaire et partagez le sur les réseaux pour qu'ensemble, nous fassions émerger la façon dont nous pourrions proposer une alternative coopérative et collective dans le cadre de l'élection présidentielle, qui en Vème République reste si monarchique.
    </Typography>
